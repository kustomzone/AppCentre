  ...
  ZeroHello = (function(_super) {
    ...
    ZeroHello.prototype.siteFavorite = function(address) {
	  ...
	  if (!favorite) {
		...
		Page.cmd("wrapperSetLocalStorage", Page.local_storage);
		// this.local_storage["site." + site + ".favorite"] = true;
		...
		Page.cmd("wrapperSetLocalStorage", Page.local_storage);
		// this.local_storage["site." + site + ".favorite"] = false;
		// this.cmd("wrapperSetLocalStorage", this.local_storage);
      ...
      return this.cmd("siteList", {}, (function(_this) {
        return function(sites) {
		  ...
		  if (sites.length < 100) {
		    ...
		    for (_i = 0, _len = sites.length; _i < _len; _i++) {
		      site = sites[_i];
			  // favorite  = Page.local_storage["site." + site.address + ".favorite"];
			  ...
			  if (typeof(favorite) === "boolean") {
				...
				if (favorite) {
		          ...
		          // alert(site.address + " peers = " + site.peers);
				}
	          }
	        }
